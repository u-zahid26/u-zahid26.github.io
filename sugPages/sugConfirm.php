<!-- Redirect page after form submission confirming comment --> 
                ...
                <div class="section1" style="text-align: center">
                    <div class="container">
                        <div class="row" style="padding-top: 70px">
                            ...
                            <div class="col-md-8">
                                <p style="text-align: center;"> Thank you for your comments. Your comments have been submitted for approval.
                                They will be reviewed by an admin within 24 hours.  </p></br>
                                <button class="button" type="submit" name="redirectHome"><a href="../index.php">Back to Home Page</button>
                            </div>
                        </div>
                    </div>
                </div>
